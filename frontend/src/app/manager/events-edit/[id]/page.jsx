  ...
  const fetchEventDetails = async () => {
    try {
      ...
      setFormData({
        ...
        eventDateTime: data.eventDateTime ? new Date(data.eventDateTime).toISOString().slice(0, 16) : '',
        city: data.city || '',
        state: data.state || '',
        zipCode: data.zipCode || '',
        address: data.address || '',
        eventInstruction: data.eventInstruction || '',
        eventCategory: data.eventCategory || '',
        eventImageBase64: data.eventImageBase64 || ''
      });
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  name="eventImageBase64"
                  value={formData.eventImageBase64}
                  onChange={handleInputChange}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  rows="4"
